...
originSignal.Node.Value % The current value is empty

post(originSignal, 21) % Post a new value to originSignal
originSignal.Node.Value % The current value is now 21

post(originSignal, 'hello') % Post a new value to originSignal
originSignal.Node.Value % The current value is now 'hello'
...
x.Node.Value % 5
y = x^2;
y.Node.Value % empty; does not evalute 5^2
x.post(3)
y.Node.Value % 9
