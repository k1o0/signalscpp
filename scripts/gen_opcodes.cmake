...
foreach(LINE IN LISTS HEADER_LINES)
    ...
    if(STRIPPED MATCHES "^([A-Za-z_][A-Za-z0-9_]*)[ \\t]*=[ \\t]*([0-9]+),?$")
        ...
        set(VALUE_KEY "00000000${VALUE}")
        string(LENGTH "${VALUE_KEY}" VALUE_KEY_LEN)
        math(EXPR VALUE_KEY_START "${VALUE_KEY_LEN} - 8")
        string(SUBSTRING "${VALUE_KEY}" ${VALUE_KEY_START} 8 VALUE_KEY)
